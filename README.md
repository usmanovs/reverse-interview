...
Definitely don't try to ask everything from the list. (Respect the interviewer's time and show initiative by finding answers on your own if they're already published). Pick your favourite 3.
...
- What technologies and stacks is Salesforce integrated with?
- How do you use source control?
- How do you test code?
- How do you track bugs?
- How do you monitor and manage projects?
...
- Do developers use sandbox or scratch org for development? 
